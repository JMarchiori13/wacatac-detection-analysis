...
15. **[YARA e Sigma](docs/15-yara-sigma.md)** 🔵 — regras prontas na pasta `rules/`: packers, tokens, LOLBins, injeção, hives, WMI, dump de lsass e phishing.

## Ruleset defensivo

A pasta [`rules/`](rules/) contém 10 regras YARA e Sigma prontas para uso e adaptação, cobrindo heurística de packer, regex de tokens, LOLBins, injeção remota, exportação de hives, dump de lsass, persistência WMI, Pass-the-Hash, staging de exfiltração e phishing.
